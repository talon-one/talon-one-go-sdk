...
// checks if the IntegrationHubEventPayloadLoyaltyProfileBasedNotification type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationHubEventPayloadLoyaltyProfileBasedNotification{}
...
func BuildIntegrationHubEventPayloadLoyaltyProfileBasedNotification(profileIntegrationID string, loyaltyProgramID int64, loyaltyProgramName string, subledgerID string, sourceOfEvent string, currentTier string, currentPoints float32, publishedAt time.Time) *IntegrationHubEventPayloadLoyaltyProfileBasedNotification {
...
func (o IntegrationHubEventPayloadLoyaltyProfileBasedNotification) ToMap() (map[string]interface{}, error) {
...
func (o *IntegrationHubEventPayloadLoyaltyProfileBasedNotification) UnmarshalJSON(data []byte) (err error) {
