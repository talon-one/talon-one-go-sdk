...
// checks if the CardLedgerPointsEntryIntegrationAPI type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CardLedgerPointsEntryIntegrationAPI{}
...
type _CardLedgerPointsEntryIntegrationAPI CardLedgerPointsEntryIntegrationAPI
...
func (o CardLedgerPointsEntryIntegrationAPI) ToMap() (map[string]interface{}, error) {
...
func (o *CardLedgerPointsEntryIntegrationAPI) UnmarshalJSON(data []byte) (err error) {
	...
	varCardLedgerPointsEntryIntegrationAPI := _CardLedgerPointsEntryIntegrationAPI{}

	err = json.Unmarshal(data, &varCardLedgerPointsEntryIntegrationAPI)

	if err != nil {
		return err
	}

	*o = CardLedgerPointsEntryIntegrationAPI(varCardLedgerPointsEntryIntegrationAPI)
