...
// checks if the RemoveItemCatalogAction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoveItemCatalogAction{}
...
func (o *RemoveItemCatalogAction) UnmarshalJSON(data []byte) (err error) {
