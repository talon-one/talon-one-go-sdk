...
// checks if the CampaignEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignEntity{}
...
func (o *CampaignEntity) UnmarshalJSON(data []byte) (err error) {
