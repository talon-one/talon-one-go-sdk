...
// checks if the ExperimentVerdict type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExperimentVerdict{}
...
func (o ExperimentVerdict) ToMap() (map[string]interface{}, error) {
...
func (o *ExperimentVerdict) UnmarshalJSON(data []byte) (err error) {
