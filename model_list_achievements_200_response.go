...
// checks if the ListAchievements200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListAchievements200Response{}
...
func (o ListAchievements200Response) MarshalJSON() ([]byte, error) {
...
func (o ListAchievements200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListAchievements200Response) UnmarshalJSON(data []byte) (err error) {
...
type NullableListAchievements200Response struct {
	value *ListAchievements200Response
	isSet bool
}

func (v NullableListAchievements200Response) Get() *ListAchievements200Response {
	return v.value
}

func (v *NullableListAchievements200Response) Set(val *ListAchievements200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListAchievements200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListAchievements200Response) Unset() {
	v.value = nil
	v.isSet = false
}
...
func (v NullableListAchievements200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAchievements200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
