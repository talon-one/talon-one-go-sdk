...
// checks if the ApplicationReferee type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationReferee{}
...
func (o ApplicationReferee) ToMap() (map[string]interface{}, error) {
...
func (o *ApplicationReferee) UnmarshalJSON(data []byte) (err error) {
