...
// checks if the ReferralRejectionReason type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReferralRejectionReason{}
...
func (o ReferralRejectionReason) ToMap() (map[string]interface{}, error) {
...
func (o *ReferralRejectionReason) UnmarshalJSON(data []byte) (err error) {
