...
type IntegrationEventV2Response struct {
	...
	CampaignEligibility []CampaignEligibility `json:"campaignEligibility,omitempty"`
...
// GetCampaignEligibility returns the CampaignEligibility field value if set, zero value otherwise.
func (o *IntegrationEventV2Response) GetCampaignEligibility() []CampaignEligibility {
	if o == nil || IsNil(o.CampaignEligibility) {
		var ret []CampaignEligibility
		return ret
	}
	return o.CampaignEligibility
}

// GetCampaignEligibilityOk returns a tuple with the CampaignEligibility field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IntegrationEventV2Response) GetCampaignEligibilityOk() ([]CampaignEligibility, bool) {
	if o == nil || IsNil(o.CampaignEligibility) {
		return nil, false
	}
	return o.CampaignEligibility, true
}

// HasCampaignEligibility returns a boolean if a field has been set.
func (o *IntegrationEventV2Response) HasCampaignEligibility() bool {
	if o != nil && !IsNil(o.CampaignEligibility) {
		return true
	}
...
// SetCampaignEligibility gets a reference to the given []CampaignEligibility and assigns it to the CampaignEligibility field.
func (o *IntegrationEventV2Response) SetCampaignEligibility(v []CampaignEligibility) {
	o.CampaignEligibility = v
}
...
func (o *IntegrationEventV2Response) GetAchievements() []CustomerAchievement {
...
// and a boolean to check if the value has been set.
func (o *IntegrationEventV2Response) GetAchievementsOk() ([]CustomerAchievement, bool) {
	if o == nil || IsNil(o.Achievements) {
		return nil, false
	}
...
func (o *IntegrationEventV2Response) HasAchievements() bool {
	if o != nil && !IsNil(o.Achievements) {
		return true
	}
...
func (o *IntegrationEventV2Response) SetAchievements(v []CustomerAchievement) {
	o.Achievements = v
}
...
func (o IntegrationEventV2Response) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CampaignEligibility) {
		toSerialize["campaignEligibility"] = o.CampaignEligibility
	}
...
func (o *IntegrationEventV2Response) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varIntegrationEventV2Response)
	...
	*o = IntegrationEventV2Response(varIntegrationEventV2Response)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "triggeredCampaigns")
		delete(additionalProperties, "campaignEligibility")
