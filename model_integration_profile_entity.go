...
// checks if the IntegrationProfileEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationProfileEntity{}
...
func (o IntegrationProfileEntity) ToMap() (map[string]interface{}, error) {
