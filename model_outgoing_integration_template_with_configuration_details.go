...
// checks if the OutgoingIntegrationTemplateWithConfigurationDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OutgoingIntegrationTemplateWithConfigurationDetails{}
...
func (o OutgoingIntegrationTemplateWithConfigurationDetails) ToMap() (map[string]interface{}, error) {
...
func (o *OutgoingIntegrationTemplateWithConfigurationDetails) UnmarshalJSON(data []byte) (err error) {
