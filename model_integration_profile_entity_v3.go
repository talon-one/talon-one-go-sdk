...
// checks if the IntegrationProfileEntityV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationProfileEntityV3{}
...
func (o *IntegrationProfileEntityV3) UnmarshalJSON(data []byte) (err error) {
