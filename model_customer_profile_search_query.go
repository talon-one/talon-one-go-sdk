...
// checks if the CustomerProfileSearchQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomerProfileSearchQuery{}
...
func (o CustomerProfileSearchQuery) ToMap() (map[string]interface{}, error) {
