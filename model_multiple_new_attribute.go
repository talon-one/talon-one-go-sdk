...
// checks if the MultipleNewAttribute type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultipleNewAttribute{}
...
func (o MultipleNewAttribute) ToMap() (map[string]interface{}, error) {
