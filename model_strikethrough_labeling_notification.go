...
// checks if the StrikethroughLabelingNotification type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StrikethroughLabelingNotification{}
...
func (o StrikethroughLabelingNotification) ToMap() (map[string]interface{}, error) {
...
func (o *StrikethroughLabelingNotification) UnmarshalJSON(data []byte) (err error) {
