...
// checks if the PatchManyItemsCatalogAction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchManyItemsCatalogAction{}
...
func (o PatchManyItemsCatalogAction) ToMap() (map[string]interface{}, error) {
