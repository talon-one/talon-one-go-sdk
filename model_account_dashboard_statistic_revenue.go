...
// checks if the AccountDashboardStatisticRevenue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountDashboardStatisticRevenue{}
...
func (o AccountDashboardStatisticRevenue) ToMap() (map[string]interface{}, error) {
...
func (o *AccountDashboardStatisticRevenue) UnmarshalJSON(data []byte) (err error) {
