...
// checks if the TierUpgradeNotificationPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TierUpgradeNotificationPolicy{}
...
type _TierUpgradeNotificationPolicy TierUpgradeNotificationPolicy
...
func (o TierUpgradeNotificationPolicy) ToMap() (map[string]interface{}, error) {
...
func (o *TierUpgradeNotificationPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	varTierUpgradeNotificationPolicy := _TierUpgradeNotificationPolicy{}

	err = json.Unmarshal(data, &varTierUpgradeNotificationPolicy)

	if err != nil {
		return err
	}

	*o = TierUpgradeNotificationPolicy(varTierUpgradeNotificationPolicy)
