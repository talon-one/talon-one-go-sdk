...
// checks if the SamlConnectionMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SamlConnectionMetadata{}
...
func (o SamlConnectionMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *SamlConnectionMetadata) UnmarshalJSON(data []byte) (err error) {
