...
// checks if the LoyaltyTierUpgradeEventRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LoyaltyTierUpgradeEventRequest{}

// LoyaltyTierUpgradeEventRequest struct for LoyaltyTierUpgradeEventRequest
type LoyaltyTierUpgradeEventRequest struct {
...
type _LoyaltyTierUpgradeEventRequest LoyaltyTierUpgradeEventRequest
...
func BuildLoyaltyTierUpgradeEventRequest(totalResultSize int64, eventType string, data []interface{}) *LoyaltyTierUpgradeEventRequest {
	this := LoyaltyTierUpgradeEventRequest{}
...
func (o LoyaltyTierUpgradeEventRequest) MarshalJSON() ([]byte, error) {
...
func (o LoyaltyTierUpgradeEventRequest) ToMap() (map[string]interface{}, error) {
...
func (o *LoyaltyTierUpgradeEventRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varLoyaltyTierUpgradeEventRequest := _LoyaltyTierUpgradeEventRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLoyaltyTierUpgradeEventRequest)

	if err != nil {
		return err
	}

	*o = LoyaltyTierUpgradeEventRequest(varLoyaltyTierUpgradeEventRequest)

	return err
}

type NullableLoyaltyTierUpgradeEventRequest struct {
	value *LoyaltyTierUpgradeEventRequest
	isSet bool
}

func (v NullableLoyaltyTierUpgradeEventRequest) Get() *LoyaltyTierUpgradeEventRequest {
	return v.value
}

func (v *NullableLoyaltyTierUpgradeEventRequest) Set(val *LoyaltyTierUpgradeEventRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableLoyaltyTierUpgradeEventRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableLoyaltyTierUpgradeEventRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func BuildNullableLoyaltyTierUpgradeEventRequest(val *LoyaltyTierUpgradeEventRequest) *NullableLoyaltyTierUpgradeEventRequest {
	return &NullableLoyaltyTierUpgradeEventRequest{value: val, isSet: true}
}

func (v NullableLoyaltyTierUpgradeEventRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLoyaltyTierUpgradeEventRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
