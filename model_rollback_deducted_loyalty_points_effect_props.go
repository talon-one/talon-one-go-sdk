...
func (o RollbackDeductedLoyaltyPointsEffectProps) ToMap() (map[string]interface{}, error) {
...
func (o *RollbackDeductedLoyaltyPointsEffectProps) UnmarshalJSON(data []byte) (err error) {
