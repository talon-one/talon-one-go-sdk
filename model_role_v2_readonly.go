...
// checks if the RoleV2Readonly type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoleV2Readonly{}
...
func (o RoleV2Readonly) ToMap() (map[string]interface{}, error) {
