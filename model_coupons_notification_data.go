...
// checks if the CouponsNotificationData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CouponsNotificationData{}
...
type _CouponsNotificationData CouponsNotificationData
...
func (o CouponsNotificationData) ToMap() (map[string]interface{}, error) {
...
func (o *CouponsNotificationData) UnmarshalJSON(data []byte) (err error) {
	...
	varCouponsNotificationData := _CouponsNotificationData{}

	err = json.Unmarshal(data, &varCouponsNotificationData)

	if err != nil {
		return err
	}

	*o = CouponsNotificationData(varCouponsNotificationData)
