...
// checks if the StrikethroughCustomEffectPerItemProps type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StrikethroughCustomEffectPerItemProps{}
...
func (o StrikethroughCustomEffectPerItemProps) ToMap() (map[string]interface{}, error) {
...
func (o *StrikethroughCustomEffectPerItemProps) UnmarshalJSON(data []byte) (err error) {
