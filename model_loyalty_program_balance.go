...
// checks if the LoyaltyProgramBalance type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LoyaltyProgramBalance{}
...
func (o LoyaltyProgramBalance) ToMap() (map[string]interface{}, error) {
...
func (o *LoyaltyProgramBalance) UnmarshalJSON(data []byte) (err error) {
