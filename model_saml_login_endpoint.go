...
// checks if the SamlLoginEndpoint type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SamlLoginEndpoint{}
...
func (o SamlLoginEndpoint) ToMap() (map[string]interface{}, error) {
...
func (o *SamlLoginEndpoint) UnmarshalJSON(data []byte) (err error) {
