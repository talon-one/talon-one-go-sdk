...
// checks if the NewCoupons type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewCoupons{}
...
func (o NewCoupons) ToMap() (map[string]interface{}, error) {
...
func (o *NewCoupons) UnmarshalJSON(data []byte) (err error) {
