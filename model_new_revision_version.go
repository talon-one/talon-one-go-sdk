...
// checks if the NewRevisionVersion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewRevisionVersion{}
...
func (o *NewRevisionVersion) GetActiveRulesetId() int32 {
	if o == nil || IsNil(o.ActiveRulesetId.Get()) {
		var ret int32
		return ret
	}
...
func (o NewRevisionVersion) ToMap() (map[string]interface{}, error) {
