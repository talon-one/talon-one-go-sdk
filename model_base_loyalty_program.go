...
// checks if the BaseLoyaltyProgram type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseLoyaltyProgram{}
...
func (o BaseLoyaltyProgram) ToMap() (map[string]interface{}, error) {
