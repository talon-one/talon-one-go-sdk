...
// checks if the InventoryReferral type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InventoryReferral{}
...
func (o InventoryReferral) ToMap() (map[string]interface{}, error) {
...
func (o *InventoryReferral) UnmarshalJSON(data []byte) (err error) {
