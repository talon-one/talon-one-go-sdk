...
// checks if the EvaluableCampaignIds type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EvaluableCampaignIds{}
...
func (o EvaluableCampaignIds) ToMap() (map[string]interface{}, error) {
