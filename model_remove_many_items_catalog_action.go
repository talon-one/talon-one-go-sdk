...
// checks if the RemoveManyItemsCatalogAction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoveManyItemsCatalogAction{}
...
func (o RemoveManyItemsCatalogAction) ToMap() (map[string]interface{}, error) {
