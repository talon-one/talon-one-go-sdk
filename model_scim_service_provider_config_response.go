...
// checks if the ScimServiceProviderConfigResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScimServiceProviderConfigResponse{}
...
func (o ScimServiceProviderConfigResponse) ToMap() (map[string]interface{}, error) {
