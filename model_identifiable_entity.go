...
// checks if the IdentifiableEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentifiableEntity{}
...
func (o *IdentifiableEntity) UnmarshalJSON(data []byte) (err error) {
