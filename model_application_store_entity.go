...
// checks if the ApplicationStoreEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationStoreEntity{}
...
func (o ApplicationStoreEntity) ToMap() (map[string]interface{}, error) {
