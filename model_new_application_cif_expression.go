...
// checks if the NewApplicationCIFExpression type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewApplicationCIFExpression{}
...
func (o NewApplicationCIFExpression) ToMap() (map[string]interface{}, error) {
