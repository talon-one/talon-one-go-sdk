...
// checks if the UpdateCampaignTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateCampaignTemplate{}
...
type _UpdateCampaignTemplate UpdateCampaignTemplate
...
func (o UpdateCampaignTemplate) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateCampaignTemplate) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateCampaignTemplate := _UpdateCampaignTemplate{}

	err = json.Unmarshal(data, &varUpdateCampaignTemplate)

	if err != nil {
		return err
	}

	*o = UpdateCampaignTemplate(varUpdateCampaignTemplate)
