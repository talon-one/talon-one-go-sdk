...
// checks if the UpdateCustomEffect type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateCustomEffect{}
...
type _UpdateCustomEffect UpdateCustomEffect

// NewUpdateCustomEffect instantiates a new UpdateCustomEffect object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func BuildUpdateCustomEffect(applicationIds []int64, name string, title string, payload string, enabled bool) *UpdateCustomEffect {
...
func (o UpdateCustomEffect) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateCustomEffect) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateCustomEffect := _UpdateCustomEffect{}

	err = json.Unmarshal(data, &varUpdateCustomEffect)

	if err != nil {
		return err
	}

	*o = UpdateCustomEffect(varUpdateCustomEffect)
...
func BuildNullableUpdateCustomEffect(val *UpdateCustomEffect) *NullableUpdateCustomEffect {
