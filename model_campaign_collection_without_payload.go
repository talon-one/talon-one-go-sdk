...
// checks if the CampaignCollectionWithoutPayload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignCollectionWithoutPayload{}
...
type _CampaignCollectionWithoutPayload CampaignCollectionWithoutPayload
...
func (o CampaignCollectionWithoutPayload) ToMap() (map[string]interface{}, error) {
...
func (o *CampaignCollectionWithoutPayload) UnmarshalJSON(data []byte) (err error) {
	...
	varCampaignCollectionWithoutPayload := _CampaignCollectionWithoutPayload{}

	err = json.Unmarshal(data, &varCampaignCollectionWithoutPayload)

	if err != nil {
		return err
	}

	*o = CampaignCollectionWithoutPayload(varCampaignCollectionWithoutPayload)
