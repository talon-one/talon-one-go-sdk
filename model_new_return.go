...
// checks if the NewReturn type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewReturn{}
...
func (o NewReturn) ToMap() (map[string]interface{}, error) {
...
func (o *NewReturn) UnmarshalJSON(data []byte) (err error) {
	...
	varNewReturn := _NewReturn{}

	err = json.Unmarshal(data, &varNewReturn)

	if err != nil {
		return err
	}

	*o = NewReturn(varNewReturn)
