...
// checks if the IntegrationHubEventPayloadCouponBasedNotifications type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationHubEventPayloadCouponBasedNotifications{}
...
func (o *IntegrationHubEventPayloadCouponBasedNotifications) UnmarshalJSON(data []byte) (err error) {
