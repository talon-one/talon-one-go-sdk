...
// checks if the UpdateReferralBatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateReferralBatch{}
...
func (o UpdateReferralBatch) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateReferralBatch) UnmarshalJSON(data []byte) (err error) {
