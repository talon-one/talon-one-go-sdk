...
// checks if the GenerateLoyaltyCard type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GenerateLoyaltyCard{}
...
func (o *GenerateLoyaltyCard) GetCustomerProfileIds() []string {
	if o == nil || IsNil(o.CustomerProfileIds) {
		var ret []string
		return ret
	}
...
func (o GenerateLoyaltyCard) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Status) {
		toSerialize["status"] = o.Status
	}
	if !IsNil(o.CustomerProfileIds) {
