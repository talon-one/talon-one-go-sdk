...
// checks if the AudienceAnalytics type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AudienceAnalytics{}
...
func (o AudienceAnalytics) ToMap() (map[string]interface{}, error) {
