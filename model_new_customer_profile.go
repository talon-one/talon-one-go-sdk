...
// checks if the NewCustomerProfile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewCustomerProfile{}
...
func (o NewCustomerProfile) ToMap() (map[string]interface{}, error) {
