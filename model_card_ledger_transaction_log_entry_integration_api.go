...
// checks if the CardLedgerTransactionLogEntryIntegrationAPI type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CardLedgerTransactionLogEntryIntegrationAPI{}
...
func (o CardLedgerTransactionLogEntryIntegrationAPI) ToMap() (map[string]interface{}, error) {
...
func (o *CardLedgerTransactionLogEntryIntegrationAPI) UnmarshalJSON(data []byte) (err error) {
