...
func (o DeductLoyaltyPointsEffectProps) ToMap() (map[string]interface{}, error) {
...
func (o *DeductLoyaltyPointsEffectProps) UnmarshalJSON(data []byte) (err error) {
