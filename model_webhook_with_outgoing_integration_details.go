...
// checks if the WebhookWithOutgoingIntegrationDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebhookWithOutgoingIntegrationDetails{}
...
func (o *WebhookWithOutgoingIntegrationDetails) GetOutgoingIntegrationTemplateId() int64 {
	if o == nil || IsNil(o.OutgoingIntegrationTemplateId) {
		var ret int64
		return ret
	}
...
func (o *WebhookWithOutgoingIntegrationDetails) GetOutgoingIntegrationTypeId() int64 {
	if o == nil || IsNil(o.OutgoingIntegrationTypeId) {
		var ret int64
		return ret
	}
...
func (o *WebhookWithOutgoingIntegrationDetails) GetOutgoingIntegrationTypeName() string {
	if o == nil || IsNil(o.OutgoingIntegrationTypeName) {
		var ret string
		return ret
	}
...
func (o WebhookWithOutgoingIntegrationDetails) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.OutgoingIntegrationTemplateId) {
		toSerialize["outgoingIntegrationTemplateId"] = o.OutgoingIntegrationTemplateId
	}
	if !IsNil(o.OutgoingIntegrationTypeId) {
...
func (o *WebhookWithOutgoingIntegrationDetails) UnmarshalJSON(data []byte) (err error) {
