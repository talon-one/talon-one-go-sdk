...
// checks if the PendingActivePointsData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PendingActivePointsData{}
...
func (o PendingActivePointsData) ToMap() (map[string]interface{}, error) {
...
func (o *PendingActivePointsData) UnmarshalJSON(data []byte) (err error) {
