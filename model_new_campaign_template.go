...
// checks if the NewCampaignTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewCampaignTemplate{}
...
func (o NewCampaignTemplate) ToMap() (map[string]interface{}, error) {
...
func (o *NewCampaignTemplate) UnmarshalJSON(data []byte) (err error) {
