...
// checks if the CreateCouponData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCouponData{}
...
type _CreateCouponData CreateCouponData
...
func (o CreateCouponData) ToMap() (map[string]interface{}, error) {
...
func (o *CreateCouponData) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateCouponData := _CreateCouponData{}

	err = json.Unmarshal(data, &varCreateCouponData)

	if err != nil {
		return err
	}

	*o = CreateCouponData(varCreateCouponData)
