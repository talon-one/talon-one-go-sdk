...
// checks if the UpdateCampaignCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateCampaignCollection{}
...
func (o UpdateCampaignCollection) ToMap() (map[string]interface{}, error) {
