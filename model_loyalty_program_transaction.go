...
// checks if the LoyaltyProgramTransaction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LoyaltyProgramTransaction{}
...
func (o LoyaltyProgramTransaction) ToMap() (map[string]interface{}, error) {
...
func (o *LoyaltyProgramTransaction) UnmarshalJSON(data []byte) (err error) {
