...
// checks if the IntegrationEventV2Request type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationEventV2Request{}
...
func (o IntegrationEventV2Request) ToMap() (map[string]interface{}, error) {
...
func (o *IntegrationEventV2Request) UnmarshalJSON(data []byte) (err error) {
