...
// checks if the CampaignSetBranchNode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignSetBranchNode{}
...
func (o CampaignSetBranchNode) ToMap() (map[string]interface{}, error) {
...
func (o *CampaignSetBranchNode) UnmarshalJSON(data []byte) (err error) {
