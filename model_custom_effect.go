...
// checks if the CustomEffect type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomEffect{}
...
func (o CustomEffect) ToMap() (map[string]interface{}, error) {
...
func (o *CustomEffect) UnmarshalJSON(data []byte) (err error) {
