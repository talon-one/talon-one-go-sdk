...
func (o *UpdateCampaign) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateCampaign := _UpdateCampaign{}

	err = json.Unmarshal(data, &varUpdateCampaign)

	if err != nil {
		return err
	}

	*o = UpdateCampaign(varUpdateCampaign)
