...
// checks if the AchievementProgress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AchievementProgress{}
...
func (o AchievementProgress) ToMap() (map[string]interface{}, error) {
...
func (o *AchievementProgress) UnmarshalJSON(data []byte) (err error) {
