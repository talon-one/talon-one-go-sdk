...
// checks if the FeaturesFeed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FeaturesFeed{}
...
func (o FeaturesFeed) ToMap() (map[string]interface{}, error) {
