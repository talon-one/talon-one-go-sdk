...
// checks if the AccountAnalytics type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountAnalytics{}
...
func (o AccountAnalytics) ToMap() (map[string]interface{}, error) {
...
func (o *AccountAnalytics) UnmarshalJSON(data []byte) (err error) {
