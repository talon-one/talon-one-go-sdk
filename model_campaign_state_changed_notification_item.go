...
// checks if the CampaignStateChangedNotificationItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignStateChangedNotificationItem{}

// CampaignStateChangedNotificationItem struct for CampaignStateChangedNotificationItem
...
func (o *CampaignStateChangedNotificationItem) UnmarshalJSON(data []byte) (err error) {
	...
	varCampaignStateChangedNotificationItem := _CampaignStateChangedNotificationItem{}

	err = json.Unmarshal(data, &varCampaignStateChangedNotificationItem)

	if err != nil {
		return err
	}

	*o = CampaignStateChangedNotificationItem(varCampaignStateChangedNotificationItem)
