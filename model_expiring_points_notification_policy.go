...
// checks if the ExpiringPointsNotificationPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpiringPointsNotificationPolicy{}
...
type _ExpiringPointsNotificationPolicy ExpiringPointsNotificationPolicy
...
func (o ExpiringPointsNotificationPolicy) ToMap() (map[string]interface{}, error) {
...
func (o *ExpiringPointsNotificationPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	varExpiringPointsNotificationPolicy := _ExpiringPointsNotificationPolicy{}

	err = json.Unmarshal(data, &varExpiringPointsNotificationPolicy)

	if err != nil {
		return err
	}

	*o = ExpiringPointsNotificationPolicy(varExpiringPointsNotificationPolicy)
