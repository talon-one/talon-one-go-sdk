...
// checks if the IntegrationState type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationState{}
...
func (o IntegrationState) ToMap() (map[string]interface{}, error) {
...
func (o *IntegrationState) UnmarshalJSON(data []byte) (err error) {
