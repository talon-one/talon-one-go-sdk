...
// checks if the ExtendLoyaltyPointsExpiryDateEffectProps type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExtendLoyaltyPointsExpiryDateEffectProps{}

// ExtendLoyaltyPointsExpiryDateEffectProps If loyalty points have an expiry date, this effect extends the expiry of all active and pending point transactions by a selected duration.
...
type _ExtendLoyaltyPointsExpiryDateEffectProps ExtendLoyaltyPointsExpiryDateEffectProps
...
func (o *ExtendLoyaltyPointsExpiryDateEffectProps) GetAffectedTransactions() []LoyaltyLedgerEntryExpiryDateChange {
	if o == nil || IsNil(o.AffectedTransactions) {
...
func (o ExtendLoyaltyPointsExpiryDateEffectProps) ToMap() (map[string]interface{}, error) {
...
func (o *ExtendLoyaltyPointsExpiryDateEffectProps) UnmarshalJSON(data []byte) (err error) {
	...
	varExtendLoyaltyPointsExpiryDateEffectProps := _ExtendLoyaltyPointsExpiryDateEffectProps{}

	err = json.Unmarshal(data, &varExtendLoyaltyPointsExpiryDateEffectProps)

	if err != nil {
		return err
	}

	*o = ExtendLoyaltyPointsExpiryDateEffectProps(varExtendLoyaltyPointsExpiryDateEffectProps)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "extensionDuration")
