...
// checks if the IntegrationHubFlowConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationHubFlowConfig{}
...
func (o IntegrationHubFlowConfig) ToMap() (map[string]interface{}, error) {
...
func (o *IntegrationHubFlowConfig) UnmarshalJSON(data []byte) (err error) {
