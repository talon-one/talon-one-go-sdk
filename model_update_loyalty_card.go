...
// checks if the UpdateLoyaltyCard type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateLoyaltyCard{}
...
func (o UpdateLoyaltyCard) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateLoyaltyCard) UnmarshalJSON(data []byte) (err error) {
