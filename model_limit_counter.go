...
// checks if the LimitCounter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LimitCounter{}
...
func (o LimitCounter) ToMap() (map[string]interface{}, error) {
...
func (o *LimitCounter) UnmarshalJSON(data []byte) (err error) {
