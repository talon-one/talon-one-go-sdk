...
// checks if the PriceDetail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PriceDetail{}
...
func (o *PriceDetail) GetAdjustmentContextId() string {
	if o == nil || IsNil(o.AdjustmentContextId) {
		var ret string
		return ret
	}
...
func (o *PriceDetail) GetAdjustmentEffectiveFrom() time.Time {
	if o == nil || IsNil(o.AdjustmentEffectiveFrom) {
		var ret time.Time
		return ret
	}
...
func (o *PriceDetail) GetAdjustmentEffectiveUntil() time.Time {
	if o == nil || IsNil(o.AdjustmentEffectiveUntil) {
		var ret time.Time
		return ret
	}
...
func (o PriceDetail) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Price) {
		toSerialize["price"] = o.Price
	}
	if !IsNil(o.AdjustmentContextId) {
	...
	if !IsNil(o.AdjustmentEffectiveFrom) {
