...
func (o SetLoyaltyPointsExpiryDateEffectProps) ToMap() (map[string]interface{}, error) {
...
func (o *SetLoyaltyPointsExpiryDateEffectProps) UnmarshalJSON(data []byte) (err error) {
