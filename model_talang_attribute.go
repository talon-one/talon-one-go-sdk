...
// checks if the TalangAttribute type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TalangAttribute{}
...
func (o TalangAttribute) ToMap() (map[string]interface{}, error) {
...
func (o *TalangAttribute) UnmarshalJSON(data []byte) (err error) {
