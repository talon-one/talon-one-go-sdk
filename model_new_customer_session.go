...
// checks if the NewCustomerSession type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewCustomerSession{}
...
func (o NewCustomerSession) ToMap() (map[string]interface{}, error) {
