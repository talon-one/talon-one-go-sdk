...
// checks if the ExpiringPointsData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpiringPointsData{}
...
type _ExpiringPointsData ExpiringPointsData
...
func (o ExpiringPointsData) ToMap() (map[string]interface{}, error) {
...
func (o *ExpiringPointsData) UnmarshalJSON(data []byte) (err error) {
	...
	varExpiringPointsData := _ExpiringPointsData{}

	err = json.Unmarshal(data, &varExpiringPointsData)

	if err != nil {
		return err
	}

	*o = ExpiringPointsData(varExpiringPointsData)
