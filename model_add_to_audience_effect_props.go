...
// checks if the AddToAudienceEffectProps type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddToAudienceEffectProps{}
...
func (o AddToAudienceEffectProps) ToMap() (map[string]interface{}, error) {
