...
// checks if the CouponLimitConfigs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CouponLimitConfigs{}
...
func (o CouponLimitConfigs) ToMap() (map[string]interface{}, error) {
