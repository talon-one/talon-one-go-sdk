...
// checks if the TierWillDowngradeData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TierWillDowngradeData{}
...
type _TierWillDowngradeData TierWillDowngradeData
...
func (o TierWillDowngradeData) ToMap() (map[string]interface{}, error) {
...
func (o *TierWillDowngradeData) UnmarshalJSON(data []byte) (err error) {
	...
	varTierWillDowngradeData := _TierWillDowngradeData{}

	err = json.Unmarshal(data, &varTierWillDowngradeData)

	if err != nil {
		return err
	}

	*o = TierWillDowngradeData(varTierWillDowngradeData)
