...
// checks if the TemplateDef type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TemplateDef{}
...
func BuildTemplateDef(id int64, created time.Time, applicationId int64, title string, category string, expr []interface{}, args []TemplateArgDef, name string) *TemplateDef {
	this := TemplateDef{}
	this.Id = id
...
func (o TemplateDef) ToMap() (map[string]interface{}, error) {
...
func (o *TemplateDef) UnmarshalJSON(data []byte) (err error) {
