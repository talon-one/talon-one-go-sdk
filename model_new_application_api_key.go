...
// checks if the NewApplicationAPIKey type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewApplicationAPIKey{}
...
func (o NewApplicationAPIKey) ToMap() (map[string]interface{}, error) {
...
func (o *NewApplicationAPIKey) UnmarshalJSON(data []byte) (err error) {
