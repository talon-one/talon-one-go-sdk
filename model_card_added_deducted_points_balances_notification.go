...
// checks if the CardAddedDeductedPointsBalancesNotification type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CardAddedDeductedPointsBalancesNotification{}
...
func (o CardAddedDeductedPointsBalancesNotification) ToMap() (map[string]interface{}, error) {
...
func (o *CardAddedDeductedPointsBalancesNotification) UnmarshalJSON(data []byte) (err error) {
