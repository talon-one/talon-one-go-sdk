...
// checks if the ApplicationAPIKey type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationAPIKey{}
...
type _ApplicationAPIKey ApplicationAPIKey
...
func (o ApplicationAPIKey) ToMap() (map[string]interface{}, error) {
...
func (o *ApplicationAPIKey) UnmarshalJSON(data []byte) (err error) {
	...
	varApplicationAPIKey := _ApplicationAPIKey{}

	err = json.Unmarshal(data, &varApplicationAPIKey)

	if err != nil {
		return err
	}

	*o = ApplicationAPIKey(varApplicationAPIKey)
