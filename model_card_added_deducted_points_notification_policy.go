...
// checks if the CardAddedDeductedPointsNotificationPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CardAddedDeductedPointsNotificationPolicy{}
...
type _CardAddedDeductedPointsNotificationPolicy CardAddedDeductedPointsNotificationPolicy
...
func (o CardAddedDeductedPointsNotificationPolicy) ToMap() (map[string]interface{}, error) {
...
func (o *CardAddedDeductedPointsNotificationPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	varCardAddedDeductedPointsNotificationPolicy := _CardAddedDeductedPointsNotificationPolicy{}

	err = json.Unmarshal(data, &varCardAddedDeductedPointsNotificationPolicy)

	if err != nil {
		return err
	}

	*o = CardAddedDeductedPointsNotificationPolicy(varCardAddedDeductedPointsNotificationPolicy)
