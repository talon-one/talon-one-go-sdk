...
// checks if the ExpiringCouponsData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpiringCouponsData{}
...
func (o ExpiringCouponsData) ToMap() (map[string]interface{}, error) {
...
func (o *ExpiringCouponsData) UnmarshalJSON(data []byte) (err error) {
