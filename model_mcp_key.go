...
// checks if the MCPKey type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MCPKey{}
...
func (o MCPKey) ToMap() (map[string]interface{}, error) {
...
func (o *MCPKey) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varMCPKey)
