...
// checks if the ExperimentSegmentInsightVariant type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExperimentSegmentInsightVariant{}
...
type _ExperimentSegmentInsightVariant ExperimentSegmentInsightVariant
...
func (o ExperimentSegmentInsightVariant) ToMap() (map[string]interface{}, error) {
...
func (o *ExperimentSegmentInsightVariant) UnmarshalJSON(data []byte) (err error) {
	...
	varExperimentSegmentInsightVariant := _ExperimentSegmentInsightVariant{}

	err = json.Unmarshal(data, &varExperimentSegmentInsightVariant)

	if err != nil {
		return err
	}

	*o = ExperimentSegmentInsightVariant(varExperimentSegmentInsightVariant)
