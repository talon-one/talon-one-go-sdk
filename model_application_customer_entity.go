...
// checks if the ApplicationCustomerEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationCustomerEntity{}
...
func (o ApplicationCustomerEntity) ToMap() (map[string]interface{}, error) {
