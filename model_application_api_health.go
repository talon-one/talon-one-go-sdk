...
// checks if the ApplicationApiHealth type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationApiHealth{}
...
func (o ApplicationApiHealth) ToMap() (map[string]interface{}, error) {
...
func (o *ApplicationApiHealth) UnmarshalJSON(data []byte) (err error) {
