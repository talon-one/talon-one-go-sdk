...
// checks if the ScimBaseGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScimBaseGroup{}
...
func (o ScimBaseGroup) ToMap() (map[string]interface{}, error) {
