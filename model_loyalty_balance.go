...
// checks if the LoyaltyBalance type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LoyaltyBalance{}
...
func (o LoyaltyBalance) ToMap() (map[string]interface{}, error) {
