...
// checks if the UpdateCouponBatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateCouponBatch{}
...
func (o UpdateCouponBatch) ToMap() (map[string]interface{}, error) {
