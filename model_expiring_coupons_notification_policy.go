...
// checks if the ExpiringCouponsNotificationPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpiringCouponsNotificationPolicy{}
...
func (o ExpiringCouponsNotificationPolicy) ToMap() (map[string]interface{}, error) {
...
func (o *ExpiringCouponsNotificationPolicy) UnmarshalJSON(data []byte) (err error) {
