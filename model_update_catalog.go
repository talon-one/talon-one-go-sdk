...
// checks if the UpdateCatalog type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateCatalog{}
...
func (o UpdateCatalog) ToMap() (map[string]interface{}, error) {
