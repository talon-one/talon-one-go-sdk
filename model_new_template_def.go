...
// checks if the NewTemplateDef type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewTemplateDef{}
...
func (o NewTemplateDef) ToMap() (map[string]interface{}, error) {
...
func (o *NewTemplateDef) UnmarshalJSON(data []byte) (err error) {
