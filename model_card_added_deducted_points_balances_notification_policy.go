...
// checks if the CardAddedDeductedPointsBalancesNotificationPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CardAddedDeductedPointsBalancesNotificationPolicy{}
...
func (o CardAddedDeductedPointsBalancesNotificationPolicy) ToMap() (map[string]interface{}, error) {
...
func (o *CardAddedDeductedPointsBalancesNotificationPolicy) UnmarshalJSON(data []byte) (err error) {
