...
// checks if the LedgerPointsEntryIntegrationAPI type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LedgerPointsEntryIntegrationAPI{}
...
func (o LedgerPointsEntryIntegrationAPI) ToMap() (map[string]interface{}, error) {
...
func (o *LedgerPointsEntryIntegrationAPI) UnmarshalJSON(data []byte) (err error) {
