...
// checks if the ApplicationNotification type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationNotification{}
...
func (o *ApplicationNotification) UnmarshalJSON(data []byte) (err error) {
