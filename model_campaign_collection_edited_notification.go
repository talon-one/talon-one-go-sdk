...
// checks if the CampaignCollectionEditedNotification type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignCollectionEditedNotification{}
...
type _CampaignCollectionEditedNotification CampaignCollectionEditedNotification
...
func (o CampaignCollectionEditedNotification) ToMap() (map[string]interface{}, error) {
...
func (o *CampaignCollectionEditedNotification) UnmarshalJSON(data []byte) (err error) {
	...
	varCampaignCollectionEditedNotification := _CampaignCollectionEditedNotification{}

	err = json.Unmarshal(data, &varCampaignCollectionEditedNotification)

	if err != nil {
		return err
	}

	*o = CampaignCollectionEditedNotification(varCampaignCollectionEditedNotification)
