...
// checks if the InventoryCoupon type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InventoryCoupon{}
...
func (o InventoryCoupon) ToMap() (map[string]interface{}, error) {
...
func (o *InventoryCoupon) UnmarshalJSON(data []byte) (err error) {
