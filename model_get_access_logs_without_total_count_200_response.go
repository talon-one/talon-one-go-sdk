...
// checks if the GetAccessLogsWithoutTotalCount200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAccessLogsWithoutTotalCount200Response{}
...
func (o GetAccessLogsWithoutTotalCount200Response) MarshalJSON() ([]byte, error) {
...
func (o GetAccessLogsWithoutTotalCount200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetAccessLogsWithoutTotalCount200Response) UnmarshalJSON(data []byte) (err error) {
...
type NullableGetAccessLogsWithoutTotalCount200Response struct {
	value *GetAccessLogsWithoutTotalCount200Response
	isSet bool
}

func (v NullableGetAccessLogsWithoutTotalCount200Response) Get() *GetAccessLogsWithoutTotalCount200Response {
	return v.value
}

func (v *NullableGetAccessLogsWithoutTotalCount200Response) Set(val *GetAccessLogsWithoutTotalCount200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAccessLogsWithoutTotalCount200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAccessLogsWithoutTotalCount200Response) Unset() {
	v.value = nil
	v.isSet = false
}
...
func (v NullableGetAccessLogsWithoutTotalCount200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAccessLogsWithoutTotalCount200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
