...
// checks if the CouponDeletionJob type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CouponDeletionJob{}
...
func (o *CouponDeletionJob) GetDeletedAmount() int64 {
	if o == nil || IsNil(o.DeletedAmount) {
		var ret int64
		return ret
	}
...
func (o CouponDeletionJob) ToMap() (map[string]interface{}, error) {
...
func (o *CouponDeletionJob) UnmarshalJSON(data []byte) (err error) {
