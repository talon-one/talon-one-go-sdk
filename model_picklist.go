...
// checks if the Picklist type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Picklist{}
...
func (o Picklist) ToMap() (map[string]interface{}, error) {
...
func (o *Picklist) UnmarshalJSON(data []byte) (err error) {
