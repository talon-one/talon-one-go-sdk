...
func BuildCustomerSession(integrationId string, created time.Time, applicationId int64, firstSession bool, updateCount int64, discounts map[string]float32, updated time.Time) *CustomerSession {
