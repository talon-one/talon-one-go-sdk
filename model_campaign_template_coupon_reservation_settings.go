...
// checks if the CampaignTemplateCouponReservationSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignTemplateCouponReservationSettings{}
...
func (o CampaignTemplateCouponReservationSettings) ToMap() (map[string]interface{}, error) {
