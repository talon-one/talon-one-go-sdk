...
// checks if the LibraryAttribute type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LibraryAttribute{}
...
func (o LibraryAttribute) ToMap() (map[string]interface{}, error) {
...
func (o *LibraryAttribute) UnmarshalJSON(data []byte) (err error) {
