...
// checks if the GetIntegrationCouponRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetIntegrationCouponRequest{}
...
func (o GetIntegrationCouponRequest) ToMap() (map[string]interface{}, error) {
...
func (o *GetIntegrationCouponRequest) UnmarshalJSON(data []byte) (err error) {
