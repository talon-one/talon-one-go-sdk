...
// checks if the NewCustomerSessionV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewCustomerSessionV2{}
...
func (o NewCustomerSessionV2) ToMap() (map[string]interface{}, error) {
