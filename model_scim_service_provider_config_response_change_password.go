...
// checks if the ScimServiceProviderConfigResponseChangePassword type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScimServiceProviderConfigResponseChangePassword{}
...
func (o ScimServiceProviderConfigResponseChangePassword) ToMap() (map[string]interface{}, error) {
