...
// checks if the CampaignRulesetChangedNotification type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignRulesetChangedNotification{}
...
func (o CampaignRulesetChangedNotification) ToMap() (map[string]interface{}, error) {
...
func (o *CampaignRulesetChangedNotification) UnmarshalJSON(data []byte) (err error) {
