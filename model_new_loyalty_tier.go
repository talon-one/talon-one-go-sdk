...
// checks if the NewLoyaltyTier type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewLoyaltyTier{}
...
type _NewLoyaltyTier NewLoyaltyTier
...
func (o NewLoyaltyTier) ToMap() (map[string]interface{}, error) {
...
func (o *NewLoyaltyTier) UnmarshalJSON(data []byte) (err error) {
	...
	varNewLoyaltyTier := _NewLoyaltyTier{}

	err = json.Unmarshal(data, &varNewLoyaltyTier)

	if err != nil {
		return err
	}

	*o = NewLoyaltyTier(varNewLoyaltyTier)
