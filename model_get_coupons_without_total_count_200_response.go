...
// checks if the GetCouponsWithoutTotalCount200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCouponsWithoutTotalCount200Response{}
...
func (o GetCouponsWithoutTotalCount200Response) MarshalJSON() ([]byte, error) {
...
func (o GetCouponsWithoutTotalCount200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetCouponsWithoutTotalCount200Response) UnmarshalJSON(data []byte) (err error) {
...
type NullableGetCouponsWithoutTotalCount200Response struct {
	value *GetCouponsWithoutTotalCount200Response
	isSet bool
}

func (v NullableGetCouponsWithoutTotalCount200Response) Get() *GetCouponsWithoutTotalCount200Response {
	return v.value
}

func (v *NullableGetCouponsWithoutTotalCount200Response) Set(val *GetCouponsWithoutTotalCount200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCouponsWithoutTotalCount200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCouponsWithoutTotalCount200Response) Unset() {
	v.value = nil
	v.isSet = false
}
...
func (v NullableGetCouponsWithoutTotalCount200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCouponsWithoutTotalCount200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
