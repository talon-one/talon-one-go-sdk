...
// checks if the ApplicationAnalyticsDataPoint type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationAnalyticsDataPoint{}
...
func (o ApplicationAnalyticsDataPoint) ToMap() (map[string]interface{}, error) {
...
func (o *ApplicationAnalyticsDataPoint) UnmarshalJSON(data []byte) (err error) {
