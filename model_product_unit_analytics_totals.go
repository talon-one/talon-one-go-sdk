...
// checks if the ProductUnitAnalyticsTotals type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductUnitAnalyticsTotals{}
...
func (o ProductUnitAnalyticsTotals) ToMap() (map[string]interface{}, error) {
