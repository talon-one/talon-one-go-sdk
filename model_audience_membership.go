...
// checks if the AudienceMembership type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AudienceMembership{}
...
type _AudienceMembership AudienceMembership
...
func (o AudienceMembership) ToMap() (map[string]interface{}, error) {
...
func (o *AudienceMembership) UnmarshalJSON(data []byte) (err error) {
	...
	varAudienceMembership := _AudienceMembership{}

	err = json.Unmarshal(data, &varAudienceMembership)

	if err != nil {
		return err
	}

	*o = AudienceMembership(varAudienceMembership)
