...
// checks if the CouponCreationJob type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CouponCreationJob{}
...
func (o CouponCreationJob) ToMap() (map[string]interface{}, error) {
...
func (o *CouponCreationJob) UnmarshalJSON(data []byte) (err error) {
