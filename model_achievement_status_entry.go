...
// checks if the AchievementStatusEntry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AchievementStatusEntry{}
...
func (o AchievementStatusEntry) ToMap() (map[string]interface{}, error) {
...
func (o *AchievementStatusEntry) UnmarshalJSON(data []byte) (err error) {
