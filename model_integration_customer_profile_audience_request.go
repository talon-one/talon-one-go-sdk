...
// checks if the IntegrationCustomerProfileAudienceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationCustomerProfileAudienceRequest{}
...
func (o IntegrationCustomerProfileAudienceRequest) ToMap() (map[string]interface{}, error) {
