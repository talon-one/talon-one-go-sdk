...
// checks if the ScimSchemaResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScimSchemaResource{}
...
func (o ScimSchemaResource) ToMap() (map[string]interface{}, error) {
