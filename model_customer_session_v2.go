...
// checks if the CustomerSessionV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomerSessionV2{}
...
func (o *CustomerSessionV2) GetExperimentVariantAllocations() []ExperimentVariantAllocation {
	if o == nil || IsNil(o.ExperimentVariantAllocations) {
...
func (o *CustomerSessionV2) GetAdditionalCostsOk() (map[string]AdditionalCost, bool) {
	if o == nil || IsNil(o.AdditionalCosts) {
		return map[string]AdditionalCost{}, false
	}
...
func (o CustomerSessionV2) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ExperimentVariantAllocations) {
...
func (o *CustomerSessionV2) UnmarshalJSON(data []byte) (err error) {
