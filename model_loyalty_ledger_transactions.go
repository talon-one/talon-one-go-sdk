...
// checks if the LoyaltyLedgerTransactions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LoyaltyLedgerTransactions{}
...
func (o LoyaltyLedgerTransactions) ToMap() (map[string]interface{}, error) {
