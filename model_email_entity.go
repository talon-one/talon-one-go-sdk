...
// checks if the EmailEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmailEntity{}
...
func (o *EmailEntity) UnmarshalJSON(data []byte) (err error) {
