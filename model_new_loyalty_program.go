...
// checks if the NewLoyaltyProgram type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewLoyaltyProgram{}
...
func (o NewLoyaltyProgram) ToMap() (map[string]interface{}, error) {
...
func (o *NewLoyaltyProgram) UnmarshalJSON(data []byte) (err error) {
