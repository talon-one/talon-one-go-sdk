...
// checks if the NewMCPKey type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewMCPKey{}
...
func (o NewMCPKey) ToMap() (map[string]interface{}, error) {
...
func (o *NewMCPKey) UnmarshalJSON(data []byte) (err error) {
