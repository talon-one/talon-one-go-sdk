...
// checks if the ApplicationSessionEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationSessionEntity{}
...
func (o *ApplicationSessionEntity) UnmarshalJSON(data []byte) (err error) {
