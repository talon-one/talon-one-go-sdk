...
// checks if the CustomerProfileAudienceRequestItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomerProfileAudienceRequestItem{}
...
type _CustomerProfileAudienceRequestItem CustomerProfileAudienceRequestItem
...
func (o CustomerProfileAudienceRequestItem) ToMap() (map[string]interface{}, error) {
...
func (o *CustomerProfileAudienceRequestItem) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomerProfileAudienceRequestItem := _CustomerProfileAudienceRequestItem{}

	err = json.Unmarshal(data, &varCustomerProfileAudienceRequestItem)

	if err != nil {
		return err
	}

	*o = CustomerProfileAudienceRequestItem(varCustomerProfileAudienceRequestItem)
