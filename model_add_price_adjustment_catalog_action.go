...
// checks if the AddPriceAdjustmentCatalogAction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddPriceAdjustmentCatalogAction{}
...
func (o AddPriceAdjustmentCatalogAction) ToMap() (map[string]interface{}, error) {
...
func (o *AddPriceAdjustmentCatalogAction) UnmarshalJSON(data []byte) (err error) {
