...
func (o *IntegrationEventV3Response) GetCampaignEligibility() []CampaignEligibility {
...
// and a boolean to check if the value has been set.
func (o *IntegrationEventV3Response) GetCampaignEligibilityOk() ([]CampaignEligibility, bool) {
	if o == nil || IsNil(o.CampaignEligibility) {
		return nil, false
	}
...
func (o *IntegrationEventV3Response) HasCampaignEligibility() bool {
	if o != nil && !IsNil(o.CampaignEligibility) {
		return true
	}
...
func (o *IntegrationEventV3Response) SetCampaignEligibility(v []CampaignEligibility) {
...
func (o *IntegrationEventV3Response) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varIntegrationEventV3Response)
