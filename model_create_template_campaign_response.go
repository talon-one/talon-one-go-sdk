...
// checks if the CreateTemplateCampaignResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTemplateCampaignResponse{}
...
func (o CreateTemplateCampaignResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CreateTemplateCampaignResponse) UnmarshalJSON(data []byte) (err error) {
