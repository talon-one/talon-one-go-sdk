...
// checks if the UpdateCoupon type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateCoupon{}
...
func (o UpdateCoupon) ToMap() (map[string]interface{}, error) {
