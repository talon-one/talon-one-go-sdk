...
// checks if the ApplicationCampaignStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationCampaignStats{}
...
func (o ApplicationCampaignStats) ToMap() (map[string]interface{}, error) {
...
func (o *ApplicationCampaignStats) UnmarshalJSON(data []byte) (err error) {
