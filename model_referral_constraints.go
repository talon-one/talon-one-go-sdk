...
// checks if the ReferralConstraints type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReferralConstraints{}
...
func (o ReferralConstraints) ToMap() (map[string]interface{}, error) {
