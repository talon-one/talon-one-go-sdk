...
// checks if the GenerateRuleTitleRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GenerateRuleTitleRule{}
...
func (o GenerateRuleTitleRule) ToMap() (map[string]interface{}, error) {
