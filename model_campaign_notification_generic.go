...
// checks if the CampaignNotificationGeneric type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignNotificationGeneric{}
...
type _CampaignNotificationGeneric CampaignNotificationGeneric
...
func (o CampaignNotificationGeneric) ToMap() (map[string]interface{}, error) {
...
func (o *CampaignNotificationGeneric) UnmarshalJSON(data []byte) (err error) {
	...
	varCampaignNotificationGeneric := _CampaignNotificationGeneric{}

	err = json.Unmarshal(data, &varCampaignNotificationGeneric)

	if err != nil {
		return err
	}

	*o = CampaignNotificationGeneric(varCampaignNotificationGeneric)
