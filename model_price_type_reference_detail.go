...
// checks if the PriceTypeReferenceDetail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PriceTypeReferenceDetail{}
...
func (o PriceTypeReferenceDetail) ToMap() (map[string]interface{}, error) {
...
func (o *PriceTypeReferenceDetail) UnmarshalJSON(data []byte) (err error) {
