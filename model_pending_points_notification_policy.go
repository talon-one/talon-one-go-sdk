...
// checks if the PendingPointsNotificationPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PendingPointsNotificationPolicy{}
...
func (o PendingPointsNotificationPolicy) ToMap() (map[string]interface{}, error) {
...
func (o *PendingPointsNotificationPolicy) UnmarshalJSON(data []byte) (err error) {
