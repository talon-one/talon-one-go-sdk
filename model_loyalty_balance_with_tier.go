...
// checks if the LoyaltyBalanceWithTier type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LoyaltyBalanceWithTier{}
...
func (o *LoyaltyBalanceWithTier) GetNegativePoints() float32 {
	if o == nil || IsNil(o.NegativePoints) {
		var ret float32
		return ret
	}
...
func (o *LoyaltyBalanceWithTier) GetProjectedTier() ProjectedTier {
	if o == nil || IsNil(o.ProjectedTier) {
...
func (o LoyaltyBalanceWithTier) ToMap() (map[string]interface{}, error) {
