...
// checks if the MultipleCustomerProfileIntegrationResponseV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultipleCustomerProfileIntegrationResponseV2{}
...
func (o *MultipleCustomerProfileIntegrationResponseV2) GetIntegrationStates() []CustomerProfileUpdateV2Response {
	if o == nil || IsNil(o.IntegrationStates) {
...
func (o MultipleCustomerProfileIntegrationResponseV2) ToMap() (map[string]interface{}, error) {
