...
// checks if the NewManagementKey type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewManagementKey{}
...
type _NewManagementKey NewManagementKey
...
func (o NewManagementKey) ToMap() (map[string]interface{}, error) {
...
func (o *NewManagementKey) UnmarshalJSON(data []byte) (err error) {
	...
	varNewManagementKey := _NewManagementKey{}

	err = json.Unmarshal(data, &varNewManagementKey)

	if err != nil {
		return err
	}

	*o = NewManagementKey(varNewManagementKey)
