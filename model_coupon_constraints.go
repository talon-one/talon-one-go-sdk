...
// checks if the CouponConstraints type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CouponConstraints{}
...
func (o CouponConstraints) ToMap() (map[string]interface{}, error) {
