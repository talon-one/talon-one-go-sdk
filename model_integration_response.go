...
func (o *IntegrationResponse) GetCampaignEligibility() []CampaignEligibility {
...
// and a boolean to check if the value has been set.
func (o *IntegrationResponse) GetCampaignEligibilityOk() ([]CampaignEligibility, bool) {
	if o == nil || IsNil(o.CampaignEligibility) {
		return nil, false
	}
...
func (o *IntegrationResponse) HasCampaignEligibility() bool {
	if o != nil && !IsNil(o.CampaignEligibility) {
		return true
	}
...
func (o *IntegrationResponse) SetCampaignEligibility(v []CampaignEligibility) {
...
func (o *IntegrationResponse) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varIntegrationResponse)
