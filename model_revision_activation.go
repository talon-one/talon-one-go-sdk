...
// checks if the RevisionActivation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RevisionActivation{}
...
func (o RevisionActivation) ToMap() (map[string]interface{}, error) {
