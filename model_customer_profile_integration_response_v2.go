...
func (o *CustomerProfileIntegrationResponseV2) GetCampaignEligibility() []CampaignEligibility {
...
// and a boolean to check if the value has been set.
func (o *CustomerProfileIntegrationResponseV2) GetCampaignEligibilityOk() ([]CampaignEligibility, bool) {
	if o == nil || IsNil(o.CampaignEligibility) {
		return nil, false
	}
...
func (o *CustomerProfileIntegrationResponseV2) HasCampaignEligibility() bool {
	if o != nil && !IsNil(o.CampaignEligibility) {
		return true
	}
...
func (o *CustomerProfileIntegrationResponseV2) SetCampaignEligibility(v []CampaignEligibility) {
...
func (o *CustomerProfileIntegrationResponseV2) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCustomerProfileIntegrationResponseV2)
