...
// checks if the NewReward type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewReward{}
...
func (o NewReward) ToMap() (map[string]interface{}, error) {
...
func (o *NewReward) UnmarshalJSON(data []byte) (err error) {
