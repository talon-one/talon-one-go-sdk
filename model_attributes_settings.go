...
// checks if the AttributesSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AttributesSettings{}
...
func (o AttributesSettings) ToMap() (map[string]interface{}, error) {
