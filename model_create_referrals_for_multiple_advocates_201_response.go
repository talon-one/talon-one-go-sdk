...
// checks if the CreateReferralsForMultipleAdvocates201Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateReferralsForMultipleAdvocates201Response{}
...
func (o CreateReferralsForMultipleAdvocates201Response) ToMap() (map[string]interface{}, error) {
...
func (o *CreateReferralsForMultipleAdvocates201Response) UnmarshalJSON(data []byte) (err error) {
