...
// checks if the OneTimeCode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OneTimeCode{}
...
func (o OneTimeCode) ToMap() (map[string]interface{}, error) {
...
func (o *OneTimeCode) UnmarshalJSON(data []byte) (err error) {
