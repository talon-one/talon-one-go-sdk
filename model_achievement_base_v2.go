...
// checks if the AchievementBaseV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AchievementBaseV2{}
...
func (o AchievementBaseV2) ToMap() (map[string]interface{}, error) {
