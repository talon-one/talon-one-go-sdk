...
// checks if the ImportEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImportEntity{}
...
func (o ImportEntity) ToMap() (map[string]interface{}, error) {
