...
// checks if the EffectEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EffectEntity{}
...
func (o *EffectEntity) UnmarshalJSON(data []byte) (err error) {
