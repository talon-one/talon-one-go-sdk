...
**ApplicationCount** | **int64** | The current number of Applications in your account. | 
**UserCount** | **int64** | The current number of Campaign Manager Users in your account. | 
**CampaignsActiveCount** | **int64** | The current number of active Campaigns in your account. | 
**CampaignsInactiveCount** | **int64** | The current number of inactive Campaigns in your account. | 
