...
**UsageCounter** | **int64** | The number of times this referral code has been successfully used. | 
...
`func NewReferral(id int64, created time.Time, campaignId int64, advocateProfileIntegrationId string, code string, usageCounter int64, ) *Referral`
