...
**CustomerSession** | Pointer to [**CustomerSessionV2**](CustomerSessionV2.md) | The session that was processed. | [optional] 
**Return** | Pointer to [**Return**](Return.md) | The return that was processed. | [optional] 
