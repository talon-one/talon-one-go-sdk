...
------------ | ------------- | ------------- | -------------
**TargetApplicationId** | **int64** | The ID of the Application to copy the experiment. It is displayed in your Talon.One deployment URL.  | 
**VariantId** | **int64** | The ID of the Experiment Variant to build the new campaign.  | 
