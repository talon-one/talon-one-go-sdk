...
**Condition** | **[]interface{}** | A Talang expression that will be evaluated in the context of the given event. | 
...
`func NewCatalogRule(title string, condition []interface{}, effects []map[string]interface{}, ) *CatalogRule`
