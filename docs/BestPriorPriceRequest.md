...
**Timeframe** | **int32** | The number of days prior to the timeframeEndDate. Only prices within this look back period are considered for the best prior price evaluation. | 
...
**Target** | Pointer to [**BestPriorPriceRequestTarget**](BestPriorPriceRequestTarget.md) |  | [optional] 
