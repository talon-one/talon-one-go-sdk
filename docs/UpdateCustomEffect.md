...
------------ | ------------- | ------------- | -------------
**ApplicationIds** | **[]int64** | The IDs of the Applications that are related to this entity. | 
...
`func NewUpdateCustomEffect(applicationIds []int64, name string, title string, payload string, enabled bool, ) *UpdateCustomEffect`
...
`func (o *UpdateCustomEffect) GetApplicationIds() []int64`

GetApplicationIds returns the ApplicationIds field if non-nil, zero value otherwise.

### GetApplicationIdsOk

`func (o *UpdateCustomEffect) GetApplicationIdsOk() (*[]int64, bool)`
...
`func (o *UpdateCustomEffect) SetApplicationIds(v []int64)`
