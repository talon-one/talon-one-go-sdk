...
------------ | ------------- | ------------- | -------------
**Applications** | **int64** | Total number of applications in the account. | 
**LiveApplications** | **int64** | Total number of live applications in the account. | 
**SandboxApplications** | **int64** | Total number of sandbox applications in the account. | 
**Campaigns** | **int64** | Total number of campaigns in the account. | 
**ActiveCampaigns** | **int64** | Total number of active campaigns in the account. | 
**LiveActiveCampaigns** | **int64** | Total number of active campaigns in live applications in the account. | 
**Coupons** | **int64** | Total number of coupons in the account. | 
**ActiveCoupons** | **int64** | Total number of active coupons in the account. | 
**ExpiredCoupons** | **int64** | Total number of expired coupons in the account. | 
**ReferralCodes** | **int64** | Total number of referral codes in the account. | 
**ActiveReferralCodes** | **int64** | Total number of active referral codes in the account. | 
**ExpiredReferralCodes** | **int64** | Total number of expired referral codes in the account. | 
**ActiveRules** | **int64** | Total number of active rules in the account. | 
**Users** | **int64** | Total number of users in the account. | 
**Roles** | **int64** | Total number of roles in the account. | 
**CustomAttributes** | **int64** | Total number of custom attributes in the account. | 
**Webhooks** | **int64** | Total number of webhooks in the account. | 
**LoyaltyPrograms** | **int64** | Total number of all loyalty programs in the account. | 
**LiveLoyaltyPrograms** | **int64** | Total number of live loyalty programs in the account. | 
**LastUpdatedAt** | **time.Time** | The point in time when the analytics numbers were updated last. | 
