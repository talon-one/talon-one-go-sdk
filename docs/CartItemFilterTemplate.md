...
**Expression** | **[]interface{}** | The Talang expression for the cart item filter. | 

## Methods

### NewCartItemFilterTemplate

`func NewCartItemFilterTemplate(name string, expression []interface{}, ) *CartItemFilterTemplate`
