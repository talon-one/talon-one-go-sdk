...
**StartDate** | **time.Time** | The start date of the period for which historical prices should be retrieved. | 
**EndDate** | **time.Time** | The end date of the period for which historical prices should be retrieved. | 
