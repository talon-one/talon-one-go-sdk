...
**CatalogId** | **int64** | The ID of the catalog that the changed item belongs to. | 
**Sku** | **string** | The unique SKU of the changed item. | 
**Version** | **int64** | The version of the changed item. | 
**Price** | **float32** | The price of the changed item. | 
...
**EvaluatedAt** | **time.Time** | The evaluation time of the changed item. | 
