...
------------ | ------------- | ------------- | -------------
**CampaignID** | **int64** | The ID of the campaign that contains the rule that failed. | 
**CampaignName** | **string** | The name of the campaign that contains the rule that failed. | 
**RulesetID** | **int64** | The ID of the ruleset that contains the rule that failed. | 
...
**RuleIndex** | **int64** | The index of the rule that failed within the ruleset. | 
