...
------------ | ------------- | ------------- | -------------
**Live** | **int64** | Number of campaigns that are active and live (across all Applications). | 
**EndingSoon** | **int64** | Campaigns scheduled to expire sometime in the next 7 days. | 
**LowOnBudget** | **int64** | Campaigns with less than 10% of budget left. | 
