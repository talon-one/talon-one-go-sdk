...
------------ | ------------- | ------------- | -------------
**Id** | **int64** | The internal ID of this blueprint. | 
**AccountId** | **int64** | The ID of the account that owns this blueprint. | 
**ApplicationId** | **int64** | The ID of the Application that owns this blueprint. | 
...
**Created** | **time.Time** | Timestamp when the blueprint was created. | 
**CreatedBy** | **int64** | ID of the user who created the blueprint. | 
**Modified** | Pointer to **time.Time** | Timestamp when the blueprint was last updated. | [optional] 
