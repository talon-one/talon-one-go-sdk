...
**AdjustmentEffectiveFrom** | Pointer to **time.Time** | The date and time from which the price adjustment is effective. | [optional] 
**AdjustmentEffectiveUntil** | Pointer to **time.Time** | The date and time until which the price adjustment is effective. | [optional] 
