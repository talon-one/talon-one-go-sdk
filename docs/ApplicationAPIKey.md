...
**Expires** | **time.Time** | The date the API key expires. | 
...
**Id** | **int64** | ID of the API Key. | 
**CreatedBy** | **int64** | ID of user who created. | 
**AccountID** | **int64** | ID of account the key is used for. | 
**ApplicationID** | **int64** | ID of application the key is used for. | 
