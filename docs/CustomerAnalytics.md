...
------------ | ------------- | ------------- | -------------
**AcceptedCoupons** | **int64** | Total accepted coupons for this customer. | 
**CreatedCoupons** | **int64** | Total created coupons for this customer. | 
**FreeItems** | **int64** | Total free items given to this customer. | 
**TotalOrders** | **int64** | Total orders made by this customer. | 
**TotalDiscountedOrders** | **int64** | Total orders made by this customer that had a discount. | 
