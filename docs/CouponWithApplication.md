...
`func NewCouponWithApplication(id int64, created time.Time, campaignId int64, usageCounter int64, applicationId int64, applicationName string, ) *CouponWithApplication`
...
`func (o *CouponWithApplication) HasValue() bool`
...
`func (o *CouponWithApplication) HasUsageLimit() bool`
