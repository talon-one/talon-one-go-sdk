...
**UsersPerCardLimit** | **int64** | The max amount of user profiles with whom a card can be shared. This can be set to &#x60;0&#x60; for no limit. | 
...
**CurrentPoints** | **float32** | The current points balance. | 
