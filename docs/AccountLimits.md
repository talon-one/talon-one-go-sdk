...
------------ | ------------- | ------------- | -------------
**LiveApplications** | **int64** | Total number of allowed live applications in the account. | 
**SandboxApplications** | **int64** | Total number of allowed sandbox applications in the account. | 
**ActiveCampaigns** | **int64** | Total number of allowed active campaigns in live applications in the account. | 
**Coupons** | **int64** | Total number of allowed coupons in the account. | 
**ReferralCodes** | **int64** | Total number of allowed referral codes in the account. | 
**ActiveRules** | **int64** | Total number of allowed active rulesets in the account. | 
**LiveLoyaltyPrograms** | **int64** | Total number of allowed live loyalty programs in the account. | 
**SandboxLoyaltyPrograms** | **int64** | Total number of allowed sandbox loyalty programs in the account. | 
**Webhooks** | **int64** | Total number of allowed webhooks in the account. | 
**Users** | **int64** | Total number of allowed users in the account. | 
**ApiVolume** | **int64** | Allowed volume of API requests to the account. | 
**PromotionTypes** | **[]string** | Array of promotion types that are employed in the account. | 
**SecondaryDeploymentPrice** | **int64** | The price for a secondary deployment according to contractual agreements. | 
