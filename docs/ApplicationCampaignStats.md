...
------------ | ------------- | ------------- | -------------
**Disabled** | **int64** | Number of disabled campaigns. | 
**Staged** | **int64** | Number of staged campaigns. | 
**Scheduled** | **int64** | Number of scheduled campaigns. | 
**Running** | **int64** | Number of running campaigns. | 
**Expired** | **int64** | Number of expired campaigns. | 
**Archived** | **int64** | Number of archived campaigns. | 
