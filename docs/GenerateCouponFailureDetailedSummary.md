...
------------ | ------------- | ------------- | -------------
**ApplicationID** | **float32** | The ID of the Application. It is displayed in your Talon.One deployment URL. | 
**SessionID** | **string** | ID of the customer session where the coupon redemption failed. | 
**EventID** | **int64** | The ID of the event for which the coupon redemption failed. | 
