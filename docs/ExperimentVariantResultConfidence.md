...
------------ | ------------- | ------------- | -------------
**AvgSessionValue** | **float32** | The calculated confidence value of the average customer session value. | 
**AvgDiscountedSessionValue** | **float32** | The calculated confidence value of the average customer discounted session value. | 
**AvgItemsPerSession** | **float32** | The calculated confidence value of the number of items from sessions value. | 
