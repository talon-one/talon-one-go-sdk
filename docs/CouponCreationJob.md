...
**CreatedAmount** | **int64** | The number of coupon codes that were already created for this request. | 
**FailCount** | **int64** | The number of times this job failed. | 
**Errors** | **[]string** | An array of individual problems encountered during the request. | 
**CreatedBy** | **int64** | ID of the user who created this effect. | 
**Communicated** | **bool** | Whether or not the user that created this job was notified of its final state. | 
**ChunkExecutionCount** | **int64** | The number of times an attempt to create a chunk of coupons was made during the processing of the job. | 
