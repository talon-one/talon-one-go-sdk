...
**CurrentPoints** | **float32** | The number of points the customer had at the time of tier downgrade. | 
**OldTier** | **string** | The name of the customer&#39;s previous tier. | 
**TierExpirationDate** | Pointer to **time.Time** | The exact date and time the tier expires. | [optional] 
