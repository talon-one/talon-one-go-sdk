...
**Modified** | **time.Time** | The date and time when the price type was last modified. | 
**SubscribedCatalogsIds** | **[]int64** | A list of the IDs of the catalogs that are subscribed to this price type. | 
**TargetedAudiencesIds** | **[]int64** | A list of the IDs of the audiences targeted by this price type. | 
