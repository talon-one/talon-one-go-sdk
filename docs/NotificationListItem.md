...
------------ | ------------- | ------------- | -------------
**NotificationId** | **int64** | The ID of the notification. | 
**NotificationName** | **string** | The name of the notification. | 
**EntityId** | **int64** | The ID of the entity to which this notification belongs. For example, in case of a loyalty notification, this value is the ID of the loyalty program.  | 
