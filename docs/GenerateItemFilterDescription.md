...
------------ | ------------- | ------------- | -------------
**ItemFilter** | **[]map[string]interface{}** | An array of item filter Talang expressions. | 

## Methods

### NewGenerateItemFilterDescription
...
### NewGenerateItemFilterDescriptionWithDefaults
...
SetItemFilter sets ItemFilter field to given value.
