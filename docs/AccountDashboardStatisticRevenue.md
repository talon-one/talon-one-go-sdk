...
------------ | ------------- | ------------- | -------------
**Total** | **float32** | All revenue that went through the client&#39;s shop (including purchases that didn’t trigger an effect). | 
**Influenced** | **float32** | The revenue that was created by a purchase that triggered an effect (excluding web hooks, notifications). | 
**Datetime** | **time.Time** | Values aggregated for the specified date. | 
