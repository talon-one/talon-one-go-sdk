...
**UserId** | **int64** | The ID of the user who created the deployment. | 
**Status** | **string** | The status of the deployment. | 
**CreatedAt** | **time.Time** | Timestamp when the deployment was created. | 
**ActiveAt** | Pointer to **time.Time** | Timestamp when the deployment became active. | [optional] 
**FailedAt** | Pointer to **time.Time** | Timestamp when the deployment failed. | [optional] 
**DeletedAt** | Pointer to **time.Time** | Timestamp when the deployment was deleted. | [optional] 
