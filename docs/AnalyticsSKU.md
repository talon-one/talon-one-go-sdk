...
------------ | ------------- | ------------- | -------------
**Id** | **int64** | The ID of the SKU linked to the Application. | 
**Sku** | **string** | The SKU linked to the Application. | 
**LastUpdated** | Pointer to **time.Time** | Values in UTC for the date the SKU linked to the product was last updated. | [optional] 
...
**UnitsSold** | Pointer to [**AnalyticsDataPointWithTrend**](AnalyticsDataPointWithTrend.md) | The number of times the product or SKU was purchased. | [optional] 
