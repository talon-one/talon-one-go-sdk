...
func (o *IntegrationStateV2) GetCampaignEligibility() []CampaignEligibility {
...
// and a boolean to check if the value has been set.
func (o *IntegrationStateV2) GetCampaignEligibilityOk() ([]CampaignEligibility, bool) {
	if o == nil || IsNil(o.CampaignEligibility) {
		return nil, false
	}
...
func (o *IntegrationStateV2) HasCampaignEligibility() bool {
	if o != nil && !IsNil(o.CampaignEligibility) {
		return true
	}
...
func (o *IntegrationStateV2) SetCampaignEligibility(v []CampaignEligibility) {
...
func (o *IntegrationStateV2) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varIntegrationStateV2)
	...
	*o = IntegrationStateV2(varIntegrationStateV2)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "previousReturns")
