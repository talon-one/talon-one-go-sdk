...
// checks if the CampaignCollectionEditedNotificationItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignCollectionEditedNotificationItem{}

// CampaignCollectionEditedNotificationItem struct for CampaignCollectionEditedNotificationItem
...
func (o *CampaignCollectionEditedNotificationItem) UnmarshalJSON(data []byte) (err error) {
	...
	varCampaignCollectionEditedNotificationItem := _CampaignCollectionEditedNotificationItem{}

	err = json.Unmarshal(data, &varCampaignCollectionEditedNotificationItem)

	if err != nil {
		return err
	}

	*o = CampaignCollectionEditedNotificationItem(varCampaignCollectionEditedNotificationItem)
