...
// checks if the AddedDeductedPointsBalancesNotification type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddedDeductedPointsBalancesNotification{}
...
func (o AddedDeductedPointsBalancesNotification) ToMap() (map[string]interface{}, error) {
...
func (o *AddedDeductedPointsBalancesNotification) UnmarshalJSON(data []byte) (err error) {
