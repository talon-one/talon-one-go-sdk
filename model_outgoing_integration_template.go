...
// checks if the OutgoingIntegrationTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OutgoingIntegrationTemplate{}
...
func (o OutgoingIntegrationTemplate) ToMap() (map[string]interface{}, error) {
...
func (o *OutgoingIntegrationTemplate) UnmarshalJSON(data []byte) (err error) {
