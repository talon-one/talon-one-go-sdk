...
// checks if the AccessLogEntry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessLogEntry{}
...
func (o AccessLogEntry) ToMap() (map[string]interface{}, error) {
...
func (o *AccessLogEntry) UnmarshalJSON(data []byte) (err error) {
