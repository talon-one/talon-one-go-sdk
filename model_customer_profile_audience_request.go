...
// checks if the CustomerProfileAudienceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomerProfileAudienceRequest{}
...
func (o CustomerProfileAudienceRequest) ToMap() (map[string]interface{}, error) {
