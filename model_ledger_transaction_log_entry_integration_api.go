...
// checks if the LedgerTransactionLogEntryIntegrationAPI type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LedgerTransactionLogEntryIntegrationAPI{}
...
func (o LedgerTransactionLogEntryIntegrationAPI) ToMap() (map[string]interface{}, error) {
...
func (o *LedgerTransactionLogEntryIntegrationAPI) UnmarshalJSON(data []byte) (err error) {
