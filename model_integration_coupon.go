...
// checks if the IntegrationCoupon type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationCoupon{}
...
func (o IntegrationCoupon) ToMap() (map[string]interface{}, error) {
...
func (o *IntegrationCoupon) UnmarshalJSON(data []byte) (err error) {
