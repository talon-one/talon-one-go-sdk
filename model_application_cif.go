...
// checks if the ApplicationCIF type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationCIF{}
...
type _ApplicationCIF ApplicationCIF
...
func (o ApplicationCIF) ToMap() (map[string]interface{}, error) {
...
func (o *ApplicationCIF) UnmarshalJSON(data []byte) (err error) {
	...
	varApplicationCIF := _ApplicationCIF{}

	err = json.Unmarshal(data, &varApplicationCIF)

	if err != nil {
		return err
	}

	*o = ApplicationCIF(varApplicationCIF)
