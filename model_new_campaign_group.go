...
// checks if the NewCampaignGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewCampaignGroup{}
...
type _NewCampaignGroup NewCampaignGroup
...
func (o NewCampaignGroup) ToMap() (map[string]interface{}, error) {
...
func (o *NewCampaignGroup) UnmarshalJSON(data []byte) (err error) {
	...
	varNewCampaignGroup := _NewCampaignGroup{}

	err = json.Unmarshal(data, &varNewCampaignGroup)

	if err != nil {
		return err
	}

	*o = NewCampaignGroup(varNewCampaignGroup)
