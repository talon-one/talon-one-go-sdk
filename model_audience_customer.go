...
// checks if the AudienceCustomer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AudienceCustomer{}
...
func (o *AudienceCustomer) GetConnectedApplicationsIds() []int64 {
	if o == nil || IsNil(o.ConnectedApplicationsIds) {
		var ret []int64
		return ret
	}
...
func (o *AudienceCustomer) GetConnectedAudiences() []int64 {
	if o == nil || IsNil(o.ConnectedAudiences) {
		var ret []int64
		return ret
	}
...
func (o AudienceCustomer) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ConnectedApplicationsIds) {
...
func (o *AudienceCustomer) UnmarshalJSON(data []byte) (err error) {
