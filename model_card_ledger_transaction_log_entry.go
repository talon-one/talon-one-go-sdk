...
// checks if the CardLedgerTransactionLogEntry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CardLedgerTransactionLogEntry{}
...
func (o CardLedgerTransactionLogEntry) ToMap() (map[string]interface{}, error) {
...
func (o *CardLedgerTransactionLogEntry) UnmarshalJSON(data []byte) (err error) {
