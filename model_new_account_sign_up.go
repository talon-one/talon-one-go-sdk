...
// checks if the NewAccountSignUp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewAccountSignUp{}
...
func (o NewAccountSignUp) ToMap() (map[string]interface{}, error) {
...
func (o *NewAccountSignUp) UnmarshalJSON(data []byte) (err error) {
