...
// checks if the IntegrationStoreEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationStoreEntity{}
...
func (o IntegrationStoreEntity) ToMap() (map[string]interface{}, error) {
