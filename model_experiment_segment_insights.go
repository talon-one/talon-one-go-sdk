...
// checks if the ExperimentSegmentInsights type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExperimentSegmentInsights{}
...
func (o ExperimentSegmentInsights) ToMap() (map[string]interface{}, error) {
...
func (o *ExperimentSegmentInsights) UnmarshalJSON(data []byte) (err error) {
