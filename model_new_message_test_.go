...
// checks if the NewMessageTest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewMessageTest{}
...
func (o NewMessageTest) ToMap() (map[string]interface{}, error) {
...
func (o *NewMessageTest) UnmarshalJSON(data []byte) (err error) {
