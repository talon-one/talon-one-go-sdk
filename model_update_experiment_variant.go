...
// checks if the UpdateExperimentVariant type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateExperimentVariant{}
...
func (o UpdateExperimentVariant) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateExperimentVariant) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateExperimentVariant := _UpdateExperimentVariant{}

	err = json.Unmarshal(data, &varUpdateExperimentVariant)

	if err != nil {
		return err
	}

	*o = UpdateExperimentVariant(varUpdateExperimentVariant)
