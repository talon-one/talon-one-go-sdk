...
// checks if the NewEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewEvent{}
...
func (o NewEvent) ToMap() (map[string]interface{}, error) {
...
func (o *NewEvent) UnmarshalJSON(data []byte) (err error) {
