...
// checks if the LoyaltyTierDowngradeEventRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LoyaltyTierDowngradeEventRequest{}

// LoyaltyTierDowngradeEventRequest struct for LoyaltyTierDowngradeEventRequest
type LoyaltyTierDowngradeEventRequest struct {
...
type _LoyaltyTierDowngradeEventRequest LoyaltyTierDowngradeEventRequest
...
func BuildLoyaltyTierDowngradeEventRequest(totalResultSize int64, eventType string, data []interface{}) *LoyaltyTierDowngradeEventRequest {
	this := LoyaltyTierDowngradeEventRequest{}
...
func (o LoyaltyTierDowngradeEventRequest) MarshalJSON() ([]byte, error) {
...
func (o LoyaltyTierDowngradeEventRequest) ToMap() (map[string]interface{}, error) {
...
func (o *LoyaltyTierDowngradeEventRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varLoyaltyTierDowngradeEventRequest := _LoyaltyTierDowngradeEventRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLoyaltyTierDowngradeEventRequest)

	if err != nil {
		return err
	}

	*o = LoyaltyTierDowngradeEventRequest(varLoyaltyTierDowngradeEventRequest)

	return err
}

type NullableLoyaltyTierDowngradeEventRequest struct {
	value *LoyaltyTierDowngradeEventRequest
	isSet bool
}

func (v NullableLoyaltyTierDowngradeEventRequest) Get() *LoyaltyTierDowngradeEventRequest {
	return v.value
}

func (v *NullableLoyaltyTierDowngradeEventRequest) Set(val *LoyaltyTierDowngradeEventRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableLoyaltyTierDowngradeEventRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableLoyaltyTierDowngradeEventRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func BuildNullableLoyaltyTierDowngradeEventRequest(val *LoyaltyTierDowngradeEventRequest) *NullableLoyaltyTierDowngradeEventRequest {
	return &NullableLoyaltyTierDowngradeEventRequest{value: val, isSet: true}
}

func (v NullableLoyaltyTierDowngradeEventRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLoyaltyTierDowngradeEventRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
