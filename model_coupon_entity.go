...
// checks if the CouponEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CouponEntity{}
...
type _CouponEntity CouponEntity
...
func (o CouponEntity) ToMap() (map[string]interface{}, error) {
...
func (o *CouponEntity) UnmarshalJSON(data []byte) (err error) {
	...
	varCouponEntity := _CouponEntity{}

	err = json.Unmarshal(data, &varCouponEntity)

	if err != nil {
		return err
	}

	*o = CouponEntity(varCouponEntity)
