...
// checks if the ScimServiceProviderConfigResponsePatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScimServiceProviderConfigResponsePatch{}
...
func (o ScimServiceProviderConfigResponsePatch) ToMap() (map[string]interface{}, error) {
