...
// checks if the HiddenConditionsEffects type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HiddenConditionsEffects{}
...
func (o *HiddenConditionsEffects) GetBuiltInEffects() []string {
	if o == nil || IsNil(o.BuiltInEffects) {
		var ret []string
		return ret
	}
...
func (o *HiddenConditionsEffects) GetCustomEffects() []int64 {
	if o == nil || IsNil(o.CustomEffects) {
		var ret []int64
		return ret
	}
...
func (o HiddenConditionsEffects) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.BuiltInEffects) {
		toSerialize["builtInEffects"] = o.BuiltInEffects
	}
	if !IsNil(o.Conditions) {
		toSerialize["conditions"] = o.Conditions
	}
	if !IsNil(o.CustomEffects) {
