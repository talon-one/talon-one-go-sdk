...
// checks if the PromotionGroupBlock type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PromotionGroupBlock{}

// PromotionGroupBlock struct for PromotionGroupBlock
type PromotionGroupBlock struct {
...
type _PromotionGroupBlock PromotionGroupBlock
...
func (o PromotionGroupBlock) MarshalJSON() ([]byte, error) {
...
func (o PromotionGroupBlock) ToMap() (map[string]interface{}, error) {
...
func (o *PromotionGroupBlock) UnmarshalJSON(data []byte) (err error) {
	...
	varPromotionGroupBlock := _PromotionGroupBlock{}

	err = json.Unmarshal(data, &varPromotionGroupBlock)

	if err != nil {
		return err
	}

	*o = PromotionGroupBlock(varPromotionGroupBlock)
...
type NullablePromotionGroupBlock struct {
	value *PromotionGroupBlock
	isSet bool
}

func (v NullablePromotionGroupBlock) Get() *PromotionGroupBlock {
	return v.value
}

func (v *NullablePromotionGroupBlock) Set(val *PromotionGroupBlock) {
	v.value = val
	v.isSet = true
}

func (v NullablePromotionGroupBlock) IsSet() bool {
	return v.isSet
}

func (v *NullablePromotionGroupBlock) Unset() {
	v.value = nil
	v.isSet = false
}

func BuildNullablePromotionGroupBlock(val *PromotionGroupBlock) *NullablePromotionGroupBlock {
	return &NullablePromotionGroupBlock{value: val, isSet: true}
}

func (v NullablePromotionGroupBlock) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePromotionGroupBlock) UnmarshalJSON(src []byte) error {
	v.isSet = true
