...
// checks if the CampaignTemplateParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignTemplateParams{}
...
func (o CampaignTemplateParams) ToMap() (map[string]interface{}, error) {
...
func (o *CampaignTemplateParams) UnmarshalJSON(data []byte) (err error) {
