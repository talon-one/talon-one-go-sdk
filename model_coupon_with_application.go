...
// checks if the CouponWithApplication type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CouponWithApplication{}
...
func BuildCouponWithApplication(id int64, created time.Time, campaignId int64, usageCounter int64, applicationId int64, applicationName string) *CouponWithApplication {
...
func (o CouponWithApplication) ToMap() (map[string]interface{}, error) {
...
func (o *CouponWithApplication) UnmarshalJSON(data []byte) (err error) {
