...
// checks if the AudienceIntegrationID type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AudienceIntegrationID{}
...
func (o AudienceIntegrationID) ToMap() (map[string]interface{}, error) {
