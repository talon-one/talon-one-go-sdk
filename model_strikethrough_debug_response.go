...
// checks if the StrikethroughDebugResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StrikethroughDebugResponse{}
...
func (o StrikethroughDebugResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.CampaignsIDs) {
