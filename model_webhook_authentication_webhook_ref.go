...
// checks if the WebhookAuthenticationWebhookRef type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebhookAuthenticationWebhookRef{}
...
func (o WebhookAuthenticationWebhookRef) ToMap() (map[string]interface{}, error) {
...
func (o *WebhookAuthenticationWebhookRef) UnmarshalJSON(data []byte) (err error) {
