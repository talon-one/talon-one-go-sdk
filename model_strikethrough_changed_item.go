...
// checks if the StrikethroughChangedItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StrikethroughChangedItem{}
...
func (o *StrikethroughChangedItem) GetPricesOk() (map[string]PriceDetail, bool) {
	if o == nil || IsNil(o.Prices) {
		return map[string]PriceDetail{}, false
	}
...
func (o StrikethroughChangedItem) ToMap() (map[string]interface{}, error) {
...
func (o *StrikethroughChangedItem) UnmarshalJSON(data []byte) (err error) {
