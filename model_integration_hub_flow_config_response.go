...
// checks if the IntegrationHubFlowConfigResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationHubFlowConfigResponse{}
...
func (o IntegrationHubFlowConfigResponse) ToMap() (map[string]interface{}, error) {
