...
// checks if the TierWillDowngradeNotificationPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TierWillDowngradeNotificationPolicy{}
...
func (o TierWillDowngradeNotificationPolicy) ToMap() (map[string]interface{}, error) {
...
func (o *TierWillDowngradeNotificationPolicy) UnmarshalJSON(data []byte) (err error) {
