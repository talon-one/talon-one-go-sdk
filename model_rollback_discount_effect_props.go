...
// checks if the RollbackDiscountEffectProps type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RollbackDiscountEffectProps{}
...
func (o *RollbackDiscountEffectProps) GetAdditionalCostId() int64 {
	if o == nil || IsNil(o.AdditionalCostId) {
		var ret int64
		return ret
	}
...
func (o *RollbackDiscountEffectProps) GetAdditionalCost() string {
	if o == nil || IsNil(o.AdditionalCost) {
		var ret string
		return ret
	}
...
func (o RollbackDiscountEffectProps) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AdditionalCostId) {
		toSerialize["additionalCostId"] = o.AdditionalCostId
	}
	if !IsNil(o.AdditionalCost) {
...
func (o *RollbackDiscountEffectProps) UnmarshalJSON(data []byte) (err error) {
