...
// checks if the CatalogsStrikethroughNotificationPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogsStrikethroughNotificationPolicy{}
...
func (o *CatalogsStrikethroughNotificationPolicy) GetAheadOfDaysTrigger() int64 {
	if o == nil || IsNil(o.AheadOfDaysTrigger) {
		var ret int64
		return ret
	}
...
func (o CatalogsStrikethroughNotificationPolicy) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["name"] = o.Name
	if !IsNil(o.AheadOfDaysTrigger) {
...
func (o *CatalogsStrikethroughNotificationPolicy) UnmarshalJSON(data []byte) (err error) {
