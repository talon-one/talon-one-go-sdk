...
// checks if the CampaignLogSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignLogSummary{}
...
func (o CampaignLogSummary) ToMap() (map[string]interface{}, error) {
...
func (o *CampaignLogSummary) UnmarshalJSON(data []byte) (err error) {
