...
// checks if the CampaignSet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignSet{}
...
func (o CampaignSet) ToMap() (map[string]interface{}, error) {
...
func (o *CampaignSet) UnmarshalJSON(data []byte) (err error) {
