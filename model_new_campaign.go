...
// checks if the NewCampaign type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewCampaign{}
...
func (o NewCampaign) ToMap() (map[string]interface{}, error) {
...
func (o *NewCampaign) UnmarshalJSON(data []byte) (err error) {
