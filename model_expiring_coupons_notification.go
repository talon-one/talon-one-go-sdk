...
// checks if the ExpiringCouponsNotification type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpiringCouponsNotification{}
...
type _ExpiringCouponsNotification ExpiringCouponsNotification
...
func (o ExpiringCouponsNotification) ToMap() (map[string]interface{}, error) {
...
func (o *ExpiringCouponsNotification) UnmarshalJSON(data []byte) (err error) {
	...
	varExpiringCouponsNotification := _ExpiringCouponsNotification{}

	err = json.Unmarshal(data, &varExpiringCouponsNotification)

	if err != nil {
		return err
	}

	*o = ExpiringCouponsNotification(varExpiringCouponsNotification)
