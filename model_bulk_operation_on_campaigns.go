...
// checks if the BulkOperationOnCampaigns type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkOperationOnCampaigns{}
...
func (o BulkOperationOnCampaigns) ToMap() (map[string]interface{}, error) {
...
func (o *BulkOperationOnCampaigns) UnmarshalJSON(data []byte) (err error) {
