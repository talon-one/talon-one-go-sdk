...
// checks if the CampaignStoreBudget type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignStoreBudget{}
...
func (o CampaignStoreBudget) ToMap() (map[string]interface{}, error) {
...
func (o *CampaignStoreBudget) UnmarshalJSON(data []byte) (err error) {
