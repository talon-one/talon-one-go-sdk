...
// checks if the CustomerAnalytics type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomerAnalytics{}
...
func (o CustomerAnalytics) ToMap() (map[string]interface{}, error) {
...
func (o *CustomerAnalytics) UnmarshalJSON(data []byte) (err error) {
