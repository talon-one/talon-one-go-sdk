...
// checks if the UpdateCampaignGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateCampaignGroup{}
...
type _UpdateCampaignGroup UpdateCampaignGroup
...
func (o UpdateCampaignGroup) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateCampaignGroup) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateCampaignGroup := _UpdateCampaignGroup{}

	err = json.Unmarshal(data, &varUpdateCampaignGroup)

	if err != nil {
		return err
	}

	*o = UpdateCampaignGroup(varUpdateCampaignGroup)
